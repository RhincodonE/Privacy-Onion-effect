...
for i in $(seq 1 $number_shadow_model); do
    ...
    python write_datasets_shadow.py --config-file $yaml_file

    python ./scripts/generate_obs.py --config-file $yaml_file
...
echo "Observations generation done!"
